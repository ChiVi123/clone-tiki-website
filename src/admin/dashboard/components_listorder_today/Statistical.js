...
export default function Statistical() {
  ...
  return (
    <div className="pt-3">
      <div className="flex flex-col-2 pl-10 mb-2">
        <div className="ml-4 flex">
          ...
          <span className="font-bold text-2xl mb-2">
            ...
            <span className="text-red-700"> {products.length} products</span>
          </span>
        </div>
      ...
      <div className="flex flex-col-2 pl-10 mb-2">
        ...
        <div className="ml-32 flex">
          ...
          <span className="font-bold text-2xl mb-2">
            Total Revenue:
            <span className="text-red-700"> {total?.toLocaleString()} VND</span>
          </span>
        </div>
      </div>
    </div>
