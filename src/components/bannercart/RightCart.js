      ...
      <div className="right-inner top-[-102px] sticky">
        <div>
          <div className="bg-[url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAu4AAADIAQMAAACNufaLAAAAA1BMVEX///+nxBvIAAAAKUlEQVR42u3BAQ0AAADCIPunNsc3YAAAAAAAAAAAAAAAAAAAAAAAACQcSjgAAcybzv4AAAAASUVORK5CYII=')] bg-cover rounded">
            <div className="rounded mb-3 relative p-4 bg-white text-[14px] leading-5">
          ...
          <div className="relative p-4 mb-3 bg-white rounded section-container">
            {/* Start Block Header*/}
        ...
        {/* Start Price Summary */}
        <div className="pb-2 bg-white rounded price-summary">
          <ul className="prices-items list-none m-0 py-[17px] px-5 border-b border-solid border-[#f4f4f4]">
        ...
        <button
          className="btn-checkout bg-[#ff424e] text-white py-[13px] px-[10px] text-center rounded border-none w-full block cursor-pointer mt-[15px] mx-0 mb-0 text-[14px]"
          onClick={handleClick}
        >
          {`Mua Hàng (${count})`}
        </button>
