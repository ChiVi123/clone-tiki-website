    ...
    const totalPrice = updatedCheckedState.reduce(
      (sum, currentState, index) => {
        if (currentState === true) {
          return sum + cartItems[index].price * cartItems[index].quantity;
        }
        return sum;
      },
      0
    ...
    <div className="flex justify-between main-content flex-nowrap basis-full">
      ...
      <div className="left-content grow-0 shrink-[1] basis-[910px]">
        <div className="left_container">
          {/* Start Left Heading*/}
          <div className="left-heading bg-white py-[9px] px-4 rounded text-[#242424] font-normal text-[13px] mb-3 sticky top-5 z-[99] grid grid-cols-[398px_190px_130px_130px_30px] items-center">
            <div className="bg-[#f5f5fa] w-full h-[21px] absolute left-0 top-[-21px] right-0"></div>
          ...
          <div className="pt-8 bg-white rounded">
            <div className="h-auto overflow-auto infinite-scroll-component">
              <div className="bg-white rounded mb-[10px]">
                ...
                <div className="seller-discount py-4 px-5 flex align-center border-t border-solid border-[#f2f2f2]">
