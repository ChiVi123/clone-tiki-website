          ...
          <div className="col-1 w-[398px] py-0 px-[15px]">
            <div className="flex list-none product-img">
              ...
              <div className="product-content width-[calc(100% - 100px)] pl-[10px] relative w-[260px]">
                ...
                >
                  {props.categoryId ===
                    "2e8c479c-6ddc-455a-b870-8ecbc11b7cd4" ||
                  props.categoryId === "1a174ce7-43b2-41d9-b29a-92b3566ab623" ||
                  props.categoryId === "795f2955-34f4-4135-b51f-95c439bd4a0f" ||
                  props.categoryId === "ad200ea1-a71e-4e55-bfc6-c226554ce60e" ||
                  props.categoryId === "dc82207c-9b22-4ad2-a14e-a8fd07bdd561" ||
                  props.categoryId === "522e1c02-fb80-4b1f-8635-063194e49c6a" ||
                  props.categoryId ===
                    "da3c04c5-3eef-41d2-9f5b-b3a9e3cbf4f8" ? (
                    <img
                ...
                {props.categoryId === "2e8c479c-6ddc-455a-b870-8ecbc11b7cd4" ||
                props.categoryId === "1a174ce7-43b2-41d9-b29a-92b3566ab623" ||
                props.categoryId === "795f2955-34f4-4135-b51f-95c439bd4a0f" ||
                props.categoryId === "ad200ea1-a71e-4e55-bfc6-c226554ce60e" ||
                props.categoryId === "dc82207c-9b22-4ad2-a14e-a8fd07bdd561" ||
                props.categoryId === "522e1c02-fb80-4b1f-8635-063194e49c6a" ||
                props.categoryId === "da3c04c5-3eef-41d2-9f5b-b3a9e3cbf4f8" ? (
            ...
            <div className="box-border list-none product-qty">
              <div className="style-qty inline-flex flex-nowrap border border-solid border-[#c8c8c8] rounded-[3px] w-[84px] list-none box-border">
                ...
                <button
                  ...
                  type="button"
                  onClick={
                    props.quantity === props.quantitySell
                      ? showAlert2
