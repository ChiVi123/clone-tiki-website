      ...
      >
        <div className="style_item items-end w-[94px] cursor-pointer my-0 mr-0 ml-4 flex text-white text-[12px]  relative tracking-[0.7px]">
          <div className="cart-wrapper relative mr-[8px] flex tracking-normal">
            ...
            />
            {cartItems.length !== 0 && (
              <span className="cart_qty tracking-normal text-[#242424] bg-[#fdd835] h-5 left-5 top-[-2px] rounded-[40px] inline-block text-center leading-5 text-[13px] font-medium absolute py-0 px-[7px]">
                {cartItems.length}
              </span>
            )}
          </div>
