  ...
  return (
    <div className="tracking-normal grow-[1] shrink-[1] basis-0">
      <div className="relative flex w-full tracking-normal shadow form">
        ...
        />
        <button
          className="btn-search tracking-normal cursor-pointer border-0 w-[120px] bg-[#0d5cb6] h-[40px] rounded-tl-[0px] rounded-tr-[2px] rounded-br-[2px] rounded-bl-[0px] text-white text-[13px] font-medium outline-0 flex items-center justify-center normal-case overflow-visible leading-[1.15] box-border m-0"
        ...
        <div className="absolute flex flex-col justify-center w-full mt-10 tracking-normal bg-white">
          {products &&
            products
              ...
              .map((item, index) => (
                <a
                  className="mx-3 my-2 text-sm cursor-pointer text-start font-awesome line-clamp-1"
                  href={`/product/${item.url_path}`}
