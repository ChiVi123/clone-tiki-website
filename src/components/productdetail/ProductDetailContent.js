...
export default function ProductDetailContent() {
  ...
  const handleAddToCart = () => {
    if (!userInfo?.user?.name) {
      navigate("/sign-in");
    } else dispatch(addToCart({ ...productDetail[0], quantity: T }));
  };
  ...
  return (
    <div className="flex w-full bg-bgHome">
      <div className="flex flex-col w-full p-4 mt-5 overflow-hidden bg-white select-none mx-44">
        <div className="flex mb-4 bg-white rounded select-text">
          {/* left */}

          <div className="relative pt-4 pb-4 pl-4 pr-4 bg-white ">
            {/* hình to */}
            ...
            <div className="mt-4 mb-0 ml-0 mr-0 basis-full shrink-0 grow-0">
              {/* list chi tiết */}
              <div className="flex ">
                {productDetail[0]?.images.map((product_detail_img, index) => (
                  <div className="relative w-16 h-16 mr-3 rounded cursor-pointer hover:border-2 hover:border-blue-500 ">
                    <img
                      ...
                      src={product_detail_img.thumbnailUrl}
                      alt=""
          ...
          {/* right */}
          <div className="basis-0 shrink-1 grow-1">
            {/* header */}
            <div className="pt-4 pb-4 pr-0 pl-7">
              {/* brand */}
              ...
              {/* title */}
              <h1 className="w-full mb-1 font-sans text-2xl font-light leading-8">
              ...
              <div className="flex mt-2">
                ...
                <div className="flex ml-4">
                  ...
                  <p className="px-2 font-sans text-sm leading-4 whitespace-nowrap">
                    Đã bán {productDetail[0]?.quantitySell}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="pr-3 mr-2 basis-0 shrink-1 grow-1">
                ...
                <div className="flex flex-col pt-3 ">
                  <div className="flex items-end pt-1 pb-1 pl-4 pr-4 mt-3 mb-0 font-sans rounded ml--4 mr--4 bg-bgPrice">
                    <div className="flex justify-center ml-1 mr-2 text-4xl font-medium text-center w-36 whitespace-nowrap text-text1">
                      {nf.format(productDetail[0]?.price)}đ
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div>
                    <button
                      type="button"
                      className="w-full h-12 max-w-xs text-white bg-red-500"
