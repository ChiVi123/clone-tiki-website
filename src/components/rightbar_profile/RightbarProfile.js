    ...
    >
      ...
      <div>
        <div className="flex text-sm formProfile">
          <div className="p-4 bg-white basis-3/5" style={{ height: "500px" }}>
            ...
            <div className="flex">
              <div className="flex-col">
                <img
                  className="mx-auto my-4 border-4 h-28 w-28 border-sky-200"
                ...
                <button
                  type="button"
                  className="px-2 text-white bg-blue-500 border rounded-lg w-fit h-9"
                  onClick={() => {
                    isOpenModal(true);
                  }}
                >
            ...
            <div className="flex my-5">
              ...
              <input
                className="w-32 p-2 mx-3 border-2 rounded-md border-slate-200 focus:border-blue-300"
                type={"date"}
                {...register("date")}
                ref={dateRef}
            ...
            <div className="flex my-5">
              ...
              <select
                className="p-2 mr-3 border-2 rounded-md border-slate-200 w-80 focus:outline-blue-300"
                name="year"
                id=""
                {...register("from")}
              >
                {userInfo?.user?.from !== "" ? (
                  <option value={userInfo?.user?.from}>
                    {userInfo?.user?.from}
                  </option>
                ) : (
          ...
          <div className="flex-col p-4 ml-1 bg-white basis-2/5 h-[500px]">
