...
const SignInPage = () => {
  ...
  return (
    <LayoutAnthentication heading="Xin chào">
      <p className="mb-6 text-xs font-normal text-center lg:text-sm text-text3 lg:mb-4 dark:text-white">
        Nếu chưa có tài khoản ?{"  "}
        <Link to="/sign-up" className="font-medium text-blue-500 underline">
          Đăng ký
        </Link>
      </p>
